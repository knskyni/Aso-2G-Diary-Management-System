...
@WebServlet("/teacher/diary/update/input")
public class TeacherDiaryUpdateInputServlet extends HttpServlet {
    @Override
    protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        // JSP
        RequestDispatcher rd = request.getRequestDispatcher("../../WEB-INF/jsp/update_input_teacher.jsp");
