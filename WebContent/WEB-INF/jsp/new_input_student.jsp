            ...
            <div class="col">
                ...
                <form action="confirm" method="POST">
                    ...
                    <div class="form-group">
                        ...
                        <textarea id="good_comment" class="form-control" name="good_comment" rows="6"></textarea>
                    </div>
                    <div class="form-group">
                        <label for="bad">今日の気になったこと</label>
                        <textarea id="bad_comment" class="form-control" name="bad_comment" rows="6"></textarea>
                    </div>
                    <div class="form-group">
                        <label for="about_comment">ひとこと</label>
                        <textarea id="about_comment" class="form-control" name="about_comment" rows="6"></textarea>
                    </div>
